-- NayaFood EMS
-- Director revenue + production data model
-- MySQL 8+
--
-- Purpose:
-- 1. Store daily production and revenue numbers per line / shift
-- 2. Feed the Director dashboard with real revenue and production metrics
-- 3. Keep the schema compatible with the existing EMS tables
